import{i as g,g as h,o as y,a as w}from"./index.esm2017-NZQW5Whv.js";let l=null,a=null,d=!1;document.addEventListener("DOMContentLoaded",()=>{if(l)return;console.log("Инициализация Firebase..."),l=g({apiKey:"AIzaSyB6N1n8dW95YGMMuTsZMRnJY1En7lK2s2M",authDomain:"dlk-diz.firebaseapp.com",projectId:"dlk-diz",storageBucket:"dlk-diz.firebasestorage.app",messagingSenderId:"209164982906",appId:"1:209164982906:web:0836fbb02e7effd80679c3"}),a=h(l),v(),x(),window.firebaseNotifications={showBrowserNotification:m,showModalNotification:b,requestNotificationPermission:f}});function v(){a&&y(a,e=>{var i,n,t,o,s,r;console.log("Получено сообщение в активном окне:",e),m(((i=e.notification)==null?void 0:i.title)||"Новое сообщение",((n=e.notification)==null?void 0:n.body)||"",e.data),b(((t=e.notification)==null?void 0:t.title)||"Новое сообщение",((o=e.notification)==null?void 0:o.body)||"",(s=e.data)==null?void 0:s.chatId,(r=e.data)==null?void 0:r.chatType),typeof u=="function"&&u()})}function x(){if(!("Notification"in window)){console.log("Этот браузер не поддерживает уведомления");return}const e=Notification.permission;console.log("Текущее разрешение для уведомлений:",e),e==="granted"?p():e!=="denied"&&k()}function k(){if(document.querySelector(".notification-permission-banner"))return;const e=document.createElement("div");e.className="notification-permission-banner",e.innerHTML=`
    ...
    `,document.body.appendChild(e),document.getElementById("allow-notifications").addEventListener("click",()=>{f()}),document.getElementById("close-notification-banner").addEventListener("click",()=>{e.remove()})}function f(){"Notification"in window&&Notification.requestPermission().then(e=>{console.log("Пользователь "+(e==="granted"?"разрешил":"не разрешил")+" уведомления");const i=document.querySelector(".notification-permission-banner");i&&i.remove(),e==="granted"&&p()}).catch(e=>{console.error("Ошибка при запросе разрешения на уведомления:",e)})}function p(){if(!("serviceWorker"in navigator)){console.error("Service Worker не поддерживается в этом браузере");return}if(d){console.log("Токен уже был сохранен ранее");return}console.log("Регистрация Service Worker..."),navigator.serviceWorker.register("/firebase-messaging-sw.js").then(e=>(console.log("Service Worker зарегистрирован:",e.scope),w(a,{vapidKey:"BLf08mEO3lePyBvZCwTzaSNX9R981qwESUblCemdDVZUT_cs4G3GD2YY38CN8ELIcPmgVRZ92G7ePzY187d4Dh4",serviceWorkerRegistration:e}))).then(e=>{e?(console.log("Получен FCM токен:",e.substring(0,20)+"..."),N(e),d=!0):(console.error("Не удалось получить токен FCM"),Notification.permission!=="granted"&&console.error("Причина: не получено разрешение на уведомления"))}).catch(e=>{console.error("Ошибка при регистрации сервис-воркера или получении токена:",e)})}function N(e){d||fetch("/firebase/update-token",{method:"POST",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":document.querySelector('meta[name="csrf-token"]').getAttribute("content")},body:JSON.stringify({token:e})}).then(i=>{i.ok?(console.log("Токен успешно сохранен на сервере"),d=!0):console.error("Ошибка при сохранении токена на сервере")}).catch(i=>{console.error("Ошибка при отправке токена:",i)})}function m(e,i,n={}){if(!("Notification"in window)){console.log("Этот браузер не поддерживает уведомления");return}if(Notification.permission==="granted")try{const t=new Notification(e,{body:i,icon:"/storage/icon/notification-icon.png",badge:"/storage/icon/badge-icon.png",tag:`chat-${(n==null?void 0:n.chatId)||"general"}`,data:n,vibrate:[200,100,200],requireInteraction:!0,renotify:!0});return t.onclick=function(){if(window.focus(),n!=null&&n.chatId&&(n!=null&&n.chatType))if(window.location.pathname.includes("/chats")){const o=document.querySelector(`[data-chat-id="${n.chatId}"][data-chat-type="${n.chatType}"]`);o&&o.click()}else window.location.href=`/chats?chatId=${n.chatId}&chatType=${n.chatType}`;t.close()},t.onerror=function(o){console.error("Ошибка показа уведомления:",o)},t}catch(t){console.error("Ошибка при создании браузерного уведомления:",t)}else Notification.permission!=="denied"&&f()}function b(e,i,n,t){const o=document.createElement("div");if(o.classList.add("firebase-notification"),o.innerHTML=`
